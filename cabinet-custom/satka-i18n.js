(function (global) {
  ...
  ru: {
    ...
    'register.success.verifyTitle': 'Проверьте почту',
    'register.success.verifyMessage': 'Мы отправили письмо со ссылкой для подтверждения. Откройте его и нажмите «Подтвердить email». Без этого войти не получится.',
  ...
  en: {
    ...
    'register.success.verifyTitle': 'Check your email',
    'register.success.verifyMessage': 'We sent a confirmation link to your inbox. Open the email and tap “Verify email”. You cannot sign in until your address is confirmed.',
